...
private:
  ...
  Field3D debug_denom,debug_soundspeed, debug_denom_beta;
  ...
  BoutReal scale_ExB;
  bool limiter_interpolate, limiter_lowT, limiter_lowN, limiter_sheath, limiter_grillix, limiter_core;
